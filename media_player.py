...
DEFAULT_SOURCES = {'28' : 'Willy',  '25': 'StuBru', '26': 'Klara', 
    '27': 'Klara Continuo'} # 'Tijdloze': 'Tijdloze',
...
class OnkyoDevice(MediaPlayerDevice):
    ...
    def raw(self, command):
        ...
        try:
            result = self._receiver.raw('PRS25')
    ...
    def update(self):
        ...
        # current_source_raw = self.command('preset query')
    ...
    def select_source(self, source):
        ...
        for post in posten:
            if post[0] == source:
                self._receiver.raw('PRS' + str(post[1]))
                return True

        raise NameError('Bestaat niet: ' + source)
        return False
